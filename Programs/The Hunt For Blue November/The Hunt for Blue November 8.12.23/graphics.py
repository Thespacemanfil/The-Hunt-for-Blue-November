...
def draw_player(map_scale, player):
    ...
    player_heading_rad = math.radians(player.tgt_heading)  # Convert heading to radians
    ...
    pygame.draw.line(screen, WHITE, (x1, z1), (x2, z2), 2)
...
def relative(map_scale, player, object):
    ...
    ship_heading_rad = math.radians(object.heading) 
