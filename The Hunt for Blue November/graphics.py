...
def draw_player(map_scale, player):
    ...
    pg.draw.aaline(screen, WHITE, (x1, z1), (x2, z2), 1)
    ...
    pg.draw.aaline(screen, BLACK, (x1, z1), (x2, z2), 3)
...
def draw_ship(map_scale, enemies, player, ship):
    ...
    # Draw the enemy line
    pg.draw.aaline(screen, RED, (x1, z1), (x2, z2), 2)
...
def draw_torpedo(map_scale, player, torpedo):
    ...
    pg.draw.aaline(screen, GRAY, (x1, z1), (x2, z2), 3)
